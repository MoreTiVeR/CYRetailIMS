...
datatable = $("#tbItemTransactionLogReport").DataTable({
    "destroy": true,
    "bFilter": true,
    "sDom": 'fBtlpi',
    'pagingType': 'numbers',
    "ordering": true,
    "ajax": {
        "url": "/Report/GetItemPriceTransactionReport",
        "type": "GET",
        "datatype": "json"
    },
    "columns": [
    ...
    initComplete: (settings, json) => {
        $('.dataTables_filter').appendTo("#tbItemTransactionLogReport");
...
$("#btnSearch").on('click', function (event) {
    ...
    var request = $.ajax({
        url: '/Report/SearchItemPriceTransactionReportByBranch',
        async: true,
        type: 'POST',
        dataType: 'JSON',
