...
function calculateFinalTotal() {
    ...
    // keep consistent formatting: if any input had decimals, show two decimals
    var hasDecimal = [deposited, customerTransfer, substitute, fee, other].some(function (x) { return x % 1 !== 0; });
    var display = hasDecimal ? total.toFixed(2) : total;

    $('#FinalTotal').val(display).trigger('change');
}
