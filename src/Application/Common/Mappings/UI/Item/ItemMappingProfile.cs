...
public class ItemMappingProfile : Profile
{
	public ItemMappingProfile()
	{
        CreateMap<GetItemListResponseDTO, EditItemViewModel>()
            ...
            .ForMember(x => x.SubItemTypeID, f => f.MapFrom(ff => ff.subitemtypeid));
        ...
        CreateMap<GetItemInBranchByBranchIDItemResponseDTO, GetItemListResponseDTO>()
            ...
            .ForMember(w => w.subitemtypeid, f => f.MapFrom(w => w.subitemtypeid))
            .ForMember(w => w.subitemtypename, f => f.MapFrom(w => w.subitemtypename));
