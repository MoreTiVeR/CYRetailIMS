...
public interface IEndOfDaySummaryAPI
{
    ...
    Task<BaseResponse<GetEndOfDaySummaryByCriteriaDetail>> SearchEndOfDaySummaryByIDAsync(GetEndOfDaySummaryByIDQuery request);
    ...
    Task<BaseResponse<CommandResponse>> DeleteEndOfDaySummaryAsync(DeleteEndOfDaySummaryCommand request);
}