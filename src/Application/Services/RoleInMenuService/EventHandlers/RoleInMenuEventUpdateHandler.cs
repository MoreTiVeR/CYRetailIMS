...
public class RoleInMenuEventUpdateHandler : INotificationHandler<TMRoleInMenuUpdateEvent>
{
    private readonly ILog4NetLogger _logger;
    public RoleInMenuEventUpdateHandler(ILog4NetLogger log4NetLogger)
    {
        _logger = log4NetLogger;
    }
    public Task Handle(TMRoleInMenuUpdateEvent notification, CancellationToken cancellationToken)
    {
