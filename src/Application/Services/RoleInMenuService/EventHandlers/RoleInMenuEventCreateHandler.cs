...
public class RoleInMenuEventCreateHandler : INotificationHandler<TMRoleInMenuCreateEvent>
{
    private readonly ILog4NetLogger _logger;
    public RoleInMenuEventCreateHandler(ILog4NetLogger log4NetLogger)
    {
        _logger = log4NetLogger;
    }
    public Task Handle(TMRoleInMenuCreateEvent notification, CancellationToken cancellationToken)
    {
