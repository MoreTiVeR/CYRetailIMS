...
public class CreateItemListValidator : AbstractValidator<CreateItemListCommand>
{
	public CreateItemListValidator()
	{
		RuleForEach(r => r.items).SetValidator(new CreateItemDetailValidator());
	}
}

public class CreateItemDetailValidator : AbstractValidator<CreateItemDetailCommand>
{
	public CreateItemDetailValidator()
	{
