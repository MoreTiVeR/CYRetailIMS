...
public class ReceiveTempCreateEventHandler : INotificationHandler<TMReceiveTemplateCreateEvent>
{
    ...
    public Task Handle(TMReceiveTemplateCreateEvent notification, CancellationToken cancellationToken)
    {
