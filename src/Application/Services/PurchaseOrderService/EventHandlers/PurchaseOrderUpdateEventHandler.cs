...
public class PurchaseOrderUpdateEventHandler : INotificationHandler<TTPurchaseOrderDetailUpdateEvent>
{
    private readonly ILog4NetLogger _logger;
    public PurchaseOrderUpdateEventHandler(ILog4NetLogger log4NetLogger)
    {
    ...
    {
        _logger.Info($"PurchaseOrderUpdateEventHandler: {notification.GetType().Name}");
