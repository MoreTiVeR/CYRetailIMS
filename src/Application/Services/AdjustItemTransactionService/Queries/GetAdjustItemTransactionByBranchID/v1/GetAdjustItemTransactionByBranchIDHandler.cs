...
internal class GetAdjustItemTransactionByBranchIDHandler : BaseService, IRequestHandler<GetAdjustItemTransactionByBranchIDQuery, BaseResponse<List<GetAdjustItemTransactionsResponseDTO>>>
{
    public GetAdjustItemTransactionByBranchIDHandler(IMapper mapper, IUnitOfWork unitOfWork) : base(mapper, unitOfWork)
    {
    }

    public async Task<BaseResponse<List<GetAdjustItemTransactionsResponseDTO>>> Handle(GetAdjustItemTransactionByBranchIDQuery request, CancellationToken cancellationToken)
    {
        List<GetAdjustItemTransactionsResponseDTO> resData = (from a in await _unitOfWork.Repository<TTAdjustItemTransaction>().QueryAsync()
                                                              ...
                                                              where a.IsActive && a.BranchID == request.branchid
