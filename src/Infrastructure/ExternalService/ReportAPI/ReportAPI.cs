...
public class ReportAPI : HttpClientService, IReportAPI
{
    ...
    public async Task<BaseResponse<List<SaleReportResponseDTO>>> GetSaleReport(SaleReportQuery saleReportQuery)
    {
    ...
    public async Task<BaseResponse<List<SaleSummaryReportResponseDTO>>> GetSaleSummaryReport(SaleSummaryReportQuery saleSummaryReportQuery)
    {
    ...
    public async Task<BaseResponse<List<AuditReportResponseDTO>>> GetAuditReport(AuditReportQuery auditReportQuery)
    {
